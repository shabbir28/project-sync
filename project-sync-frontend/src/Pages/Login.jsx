...
const Login = () => {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        setForgotMessage(data.message || 'If this email exists, a reset link will be sent.');
      } else {
    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 relative overflow-hidden pt-16 md:pt-0">
        ...
        <img
          src={trelloLeftImage}
          alt="Trello Left"
          className="hidden md:block absolute left-0 top-1/2 transform -translate-y-1/2 w-64 opacity-30 z-0 pointer-events-none"
          style={{ maxHeight: '80vh' }}
        />
        <img
          src={trelloRightImage}
          alt="Trello Right"
        ...
        <div className="relative z-10 max-w-md w-full mx-8 my-20">
          <div className="bg-white rounded-2xl shadow-2xl px-10 py-10 flex flex-col items-center">
            <img
              className="h-20 w-20 rounded-full shadow-lg mb-4 border-4 border-blue-200"
              src={projectLogo}
              alt="Project Sync"
            />
            ...
            <p className="text-gray-500 mb-6 text-center">
              ...
              <Link to="/signup" className="text-blue-600 font-semibold hover:underline">create a new account</Link>
            </p>
            {serverError && (
            ...
            <form className="w-full space-y-5" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border ${errors.email ? 'border-red-400' : 'border-blue-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 bg-blue-50`}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-2 border ${errors.password ? 'border-red-400' : 'border-blue-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 bg-blue-50`}
                    placeholder="Enter your password"
                  />
                  <button
                    type="button"
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 text-blue-500 text-xs focus:outline-none"
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <button
                    type="button"
                    className="text-blue-600 hover:underline bg-transparent border-none p-0 m-0 focus:outline-none"
              ...
              <div className="mt-4">
                <Link
                  to="/signup"
                  className="w-full py-2 px-4 border border-blue-500 text-blue-600 font-semibold rounded-lg shadow-md hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all duration-200 flex items-center justify-center"
                >
                  Create New Account
                </Link>
              </div>
